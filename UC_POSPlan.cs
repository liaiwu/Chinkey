...
namespace SSAPP
{
    public partial class UC_POSPlan : UCEditBase
    {
        protected EditGrid dataGrid = new EditGrid();
        protected EditGrid dataGrid1 = new EditGrid();
        protected EditGrid dataGrid2 = new EditGrid();
        ...
        private void myInit()
        {
            ...
            dataGrid2.NewItemRowPosition = NewItemRowPosition.None;
            dataGrid2.Name = "dataGrid3" + this.GetType().ToString();
            dataGrid2.CanEdit = false;
            dataGrid2.CanDelete = false;
            dataGrid2.IsShowFooter = false;
            this.panel5.Controls.Add(dataGrid2);
            dataGrid2.SetCaption(ViewName1);
